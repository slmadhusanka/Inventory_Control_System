...
namespace Inventory_Control_System
{
    public partial class pettyCashForm : Form
    {
        ...
        public void Bank_DOC_ID_Generate()
        {
        ...
        public void Available_Cash_Total()
        {
            ...
            try
            {
                ...
                if (!dr.Read())
                {
                    ...
                    string Cal_Current_Cash = @"SELECT     SUM(InvoicePaymentDetails.PayCash) AS TotalCash FROM InvoicePaymentDetails FULL OUTER JOIN SoldInvoiceDetails 
                                                ON InvoicePaymentDetails.InvoiceID=SoldInvoiceDetails.InvoiceNo FULL OUTER JOIN RepairNotes ON InvoicePaymentDetails.InvoiceID=RepairNotes.ReJobNumber
                                                WHERE (SoldInvoiceDetails.InvoiceStatus='Sold' OR RepairNotes.JobStatus='1')";
                ...
                else
                {
                    ...
                    string Cal_Current_Cash = @"SELECT     SUM(InvoicePaymentDetails.PayCash) AS TotalCash FROM InvoicePaymentDetails FULL OUTER JOIN SoldInvoiceDetails 
                                                ON InvoicePaymentDetails.InvoiceID=SoldInvoiceDetails.InvoiceNo FULL OUTER JOIN RepairNotes ON InvoicePaymentDetails.InvoiceID=RepairNotes.ReJobNumber
                                                WHERE (SoldInvoiceDetails.InvoiceStatus='Sold' OR RepairNotes.JobStatus='1') AND InvoicePaymentDetails.Invoice_Auto_ID>'" + Auto_ID + "'";
        ...
        public void Tab2Cear()
        {
            #region clear balace amount----------------------
        ...
        private void rbtPaidMoney_CheckedChanged(object sender, EventArgs e)
        {
            #region check cash issu...........................................
            //if (rbtPaidMoney.Checked == true)
            //{

            //    cmbReson.Enabled = true;
            //    //txtRicever.Enabled = false;
        ...
        private void rntRecrviedMoney_CheckedChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dgResult == DialogResult.Yes)
                {
                    ...
                    if (!dr.Read())
                    {
                        ...
                        cnnz.Open();
                        string insert1z = @"INSERT INTO PettyCash_Balance (Petty_Cash_ID, Petty_Cash_Auto_ID, Update_Status, Amount, Current_Bal) VALUES('" + PettyCash_ID.Text + "','00','Credited','" + TotAmount.Text + "','" + Now_balance_Payment + "')";
                    ...
                    else
                    {
                        ...
                        SqlConnection cnnz = new SqlConnection(IMS);
                        cnnz.Open();
                        string insert1z = @"INSERT INTO PettyCash_Balance (Petty_Cash_ID, Petty_Cash_Auto_ID, Update_Status, Amount, Current_Bal) VALUES('" + PettyCash_ID.Text + "','00','Credited','" + TotAmount.Text + "','" + current_Bal + "')";
                        SqlCommand cmmz = new SqlCommand(insert1z, cnnz);
                        cmmz.ExecuteNonQuery();
        ...
        private void pettyCashForm_Load(object sender, EventArgs e)
        {
        ...
        {
            int x = lv.Width / 25 == 0 ? 1 : lv.Width / 25;
        ...
        private void pettyCashForm_SizeChanged(object sender, EventArgs e)
        {

        }

        private void txtDiscrip_Resize(object sender, EventArgs e)
        {
        ...
        private void txtRicever_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyValue == 13)
            {
                cmbPayer.Focus();
        ...
        private void PnlVendorSerch_MouseLeave(object sender, EventArgs e)
        {
        ...
        private void txtamounttab2_Leave(object sender, EventArgs e)
        {
            if (RecievedAmount.Text == "")
            {
                RecievedAmount.Text = "0.0";
        ...
        private void listView2_KeyDown(object sender, KeyEventArgs e)
        {
            ...
            DateFilter.Text = item.SubItems[0].Text;
            //txtBankname.Text = item.SubItems[1].Text;
            txttab2Desceip.Text = item.SubItems[2].Text;
            // txttab2ChequeNo.Text = item.SubItems[3].Text;
            RecievedAmount.Text = item.SubItems[4].Text;
        ...
        private void txtamounttab2_KeyPress(object sender, KeyPressEventArgs e)
        {
            #region type only dcimal
            if (!char.IsControl(e.KeyChar) && !char.IsDigit(e.KeyChar) && e.KeyChar != '.')
            {
        ...
        private void txttab2ChequeNo_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyValue == 13)
            {
                RecievedAmount.Focus();
        ...
        private void txtamounttab2_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyValue == 13)
            {
                btnTab2save.Focus();
        ...
        private void btnTab2save_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void btnTab2save_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                SqlConnection cnnz = new SqlConnection(IMS);
                cnnz.Open();
                string insert1z = @"INSERT INTO PettyCash_Balance (Petty_Cash_ID, Petty_Cash_Auto_ID, Update_Status, Amount, Current_Bal) VALUES('" + PetID.Text + "','" + Auto_Pet_ID.Text + "','Updated','" + RecievedAmount.Text + "','" + current_Bal + "')";
                SqlCommand cmmz = new SqlCommand(insert1z, cnnz);
                cmmz.ExecuteNonQuery();
        ...
        private void RecievedAmount_KeyUp(object sender, KeyEventArgs e)
        {
            
        }

        private void RecivedBy_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void cmbBankNameCredit_MouseClick(object sender, MouseEventArgs e)
        {
            Select_Bank();
        }
        ...
        private void txtBankIdCredit_TabIndexChanged(object sender, EventArgs e)
        {
        ...
        private void txtBankIdCredit_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                //=====================================================================================================================
                string sql = "SELECT Account_Num FROM Bank_Account_Details WHERE BankID='" + txtBankIdCredit.Text + "' AND Account_Type='Current Acc' AND Ck_Book_Status='1'";
                SqlCommand cmd = new SqlCommand(sql, Conn);
                SqlDataReader dr = cmd.ExecuteReader();
        ...
        private void button3_Click_1(object sender, EventArgs e)
       {
                ...
                if (dgResult == DialogResult.Yes)
                {
                    ...
                    if (Rbt_frm_Chk.Checked == true)
                    {
                        ...
                        for (int i = 0; i <= listView2.Items.Count - 1; i++)
                        {
                            ...
                            #region calculate and update bank balance..............................................
                            ...
                            #region update Bank_Doc_details tablr------------------------------------------------
                        ...
                        try
                        {
                           // MessageBox.Show("1");
                            ...
                            string insernewid = @"insert into Set_Off_Details(DOC_Num, Status, InvoiceAutoID, Setoff_Balance,Invoiced_Tot, Bank_amount, Remain_Balance, LgUser, Set_Off_Date) 
                                        values('" + lblPeetyIDCredit.Text + "','" + Balance_Status + "','" + Invoiced_Last_Auto_ID + "','" + New_Balance.Text + "','0','"+Lbl_Tot_list.Text+"','" + Remaining_Balance.Text + "','" + LgUser.Text + "','" + DateTime.Now.ToString() + "') ";
                            SqlCommand cmm = new SqlCommand(insernewid, cnn);
                            cmm.ExecuteNonQuery();
                            cnn.Close();
                    ...
                    for (int i = 0; i <= listView2.Items.Count - 1; i++)
                    {
                        SqlConnection cnn = new SqlConnection(IMS);
                        cnn.Open();
                        string insertBalance = @"insert into [PettyCash_Balance]( [Petty_Cash_ID],[Petty_Cash_Auto_ID],[Update_Status],[Amount],[Current_Bal] ) values( @Petty_Cash_ID,@Petty_Cash_Auto_ID,@Update_Status,@Amount,@Current_Bal)";
                    ...
                    //SqlConnection cnnselectPetty = new SqlConnection(IMS);
                    // cnnselectPetty.Open();
                    //string selecttopPettyId = "SELECT TOP 1 [Balance] FROM [Petty_Cash] order by [peety_ID] desc";
                    //SqlCommand cmmda = new SqlCommand(selecttopPettyId, cnnselectPetty);
                    //SqlDataReader dr1 = cmmda.ExecuteReader();
                    //while (dr1.Read())
                    //{
                    //    additonpeycash = dr1[0].ToString();

                    //}
                    //ListViewItem li2 = listView2.Items[0];
                    //addlist = li2.SubItems[6].Text.ToString();
                    //balancepeycash = ((Double.Parse(additonpeycash)) + Double.Parse(addlist)).ToString();
        ...
        private void PayedTo_SelectedIndexChanged(object sender, EventArgs e)
        {
            //if(PayedTo.SelectedIndex.ToString()!="")
            //{
            //    //RecivedBy.DroppedDown = true;
            //    //RecivedBy.Focus();
            //}
