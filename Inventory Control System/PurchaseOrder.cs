...
namespace Inventory_Control_System
{
    public partial class PurchaseOrder : Form
    {
            ...
            try
            {
                ...
                for (int i = 0; i <= LstShow.Items.Count - 1; i++)
                {
                    ...
                    if (LstShow.Items[i].SubItems[0].Text == txtItemID.Text)
                    {
                        ...
                        {
                            //-----------------------------------------------------------------------------------
                            Double PurchesU = Double.Parse(txtsellingPrice.Text);
                            Double qtyU = Double.Parse(textBox4.Text);
                            Double DiscountU = Double.Parse(txtDiscount.Text);
                            Double qtySellingU = PurchesU * qtyU;
                            Double addU = 0;
                            Double balanceU;
                            ...
                            if (chkItmDiscPer.Checked == true)
                            {
                                ...
                                addU = (qtySellingU / 100) * DiscountU;
                                addlist_discvalue = addU.ToString();

                                balanceU = qtySellingU - addU;

                                Amount1U = balanceU.ToString();
                            ...
                            if (chkItmDiscPer.Checked == false)
                            {
                                ...
                                addU = qtySellingU - DiscountU;

                                Amount1U = addU.ToString();
                            ...
                            LstShow.Items[i].SubItems[11].Text = Convert.ToString((Convert.ToDouble(LstShow.Items[i].SubItems[11].Text) + Convert.ToDouble(Amount1U)));
        ...
        private void txtCalDiscount_TextChanged(object sender, EventArgs e)
        {
            ...
            txtMasterDis.Text = txtCalDiscount.Text;
        }
        ...
        private void LstShow_DragDrop(object sender, DragEventArgs e)
        {
