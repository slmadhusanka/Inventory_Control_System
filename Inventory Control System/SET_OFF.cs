...
namespace Inventory_Control_System
{
    public partial class SET_OFF : Form
    {
          ...
          //  MessageBox.Show("Available_Cash_Total");    
                ...
                if (!dr.Read())
                {
                   // MessageBox.Show("NOt Read");
                    ...
                    string Cal_Current_Cash = @"SELECT        SUM(InvoicePaymentDetails.PayCash) AS TotalCash
                         ...
                         RepairNotes ON InvoicePaymentDetails.InvoiceID = RepairNotes.ReJobNumber FULL OUTER JOIN
                         Photocopy_DOC_Details ON InvoicePaymentDetails.InvoiceID = Photocopy_DOC_Details.PhotoC_Invoice_ID FULL OUTER JOIN
                         Customer_Payment_Doc_Details on InvoicePaymentDetails.InvoiceID =Customer_Payment_Doc_Details.Docu_No
                         WHERE (SoldInvoiceDetails.InvoiceStatus='Sold' OR RepairNotes.JobStatus='1' OR Photocopy_DOC_Details.Doc_Status='1' OR Customer_Payment_Doc_Details.DOC_Status='1') AND InvoicePaymentDetails.Invoice_Auto_ID>'0'";
                ...
                else
                {
                   // MessageBox.Show("Read");
                    ...
                    string Cal_Current_Cash = @"SELECT        SUM(InvoicePaymentDetails.PayCash) AS TotalCash
                         ...
                         Photocopy_DOC_Details ON InvoicePaymentDetails.InvoiceID = Photocopy_DOC_Details.PhotoC_Invoice_ID FULL OUTER JOIN
                         Customer_Payment_Doc_Details on InvoicePaymentDetails.InvoiceID =Customer_Payment_Doc_Details.Docu_No
                         WHERE (SoldInvoiceDetails.InvoiceStatus='Sold' OR RepairNotes.JobStatus='1' OR Photocopy_DOC_Details.Doc_Status='1' OR Customer_Payment_Doc_Details.DOC_Status='1') AND InvoicePaymentDetails.Invoice_Auto_ID>'" + Auto_ID + "'";
        ...
        private void SET_OFF_Load(object sender, EventArgs e)
        {
            ...
            //MessageBox.Show("cash load amount "+ New_Cash_Balance.Text);
        }
        ...
        private void New_Balance_TextChanged(object sender, EventArgs e)
        {
            
        }

        private void SET_OFF_VisibleChanged(object sender, EventArgs e)
        {
            //Last_Invoice_Auto_ID_Select();
        }
