...
{
    public partial class Deposit_Details : Form
    {
        ...
        public void slectAccName()
        {
            ...
            string CusSelectAll = "select Account_Num,Acc_Name  from Bank_Account_Details  ";
            SqlCommand cmd1 = new SqlCommand(CusSelectAll, con1);
            SqlDataReader dr = cmd1.ExecuteReader();
            ...
            while (dr.Read())
            {
                cmbAccName.Items.Add(dr[1].ToString());
            }
            cmd1.Dispose();
            dr.Close();
        ...
        String topBalance;
        public void select_lastBalance_bankBalance ()
        {
            #region select_lastBalance_bankBalance..................................
            SqlConnection conn = new SqlConnection(IMS);
            conn.Open();
            String tovalue = "select top 1 Balance from Bank_Balance order by Bal_Auto_ID desc";
            SqlCommand cmm = new SqlCommand(tovalue, conn);
            SqlDataReader dr = cmm.ExecuteReader();
            if (dr.Read())
            {
               topBalance = dr[0].ToString();
            }
            #endregion
        }
        String AutoId;
        public void loadsetOff()
        {
            ...
            cnnoff.Open();
            String setoffvaluetop = "select top 1 Remain_Balance,InvoiceAutoID from Set_Off_Details  order by AutoID desc";
                ...
                if (dgResult == DialogResult.Yes)
                {
                    ...
                    if (Double.Parse(txtAmount.Text) > 0.0)
                    {
                        ...
                        try
                        {
                            ...
                            cnn5.Open();
                            String AddSetoFF = @"INSERT INTO [Set_Off_Details]([DOC_Num],[Status],[InvoiceAutoID],[Setoff_Balance],[Invoiced_Tot],[Bank_amount],[Remain_Balance],[LgUser],[Set_Off_Date])values('" + lbldepositID.Text + "','" + "Deposit" + "','" + AutoId + "','" + lblremainig.Text + "','" + "0.00" + "','" + txtAmount.Text + "','" + lblCurrently.Text + "','" + LgUser.Text + "','" + DateTime.Now.ToString() + "')";
        ...
        private void lbldepositID_Click(object sender, EventArgs e)
        {

        }

        private void Deposit_Details_Load(object sender, EventArgs e)
        {
        ...
        private void txtBankIdCredit_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                //=====================================================================================================================
                string sql = "SELECT Account_Num FROM Bank_Account_Details WHERE BankID='" + txtBankIdCredit.Text + "'";
                SqlCommand cmd = new SqlCommand(sql, Conn);
                SqlDataReader dr = cmd.ExecuteReader();
                ...
                {
                    MessageBox.Show("This Bank Do Not have any account. please select anothe Bank", "Not availlabe bank", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    // txtBank.Focus();
                }
